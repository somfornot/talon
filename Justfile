...
# Exercise the public C ABI through a real coordinator, worker and origin.
# MODE can be smoke, hot, latency, backend, failure, membership or all.
client-path-bench *ARGS:
    scripts/c_client_loadtest.sh {{ARGS}}
